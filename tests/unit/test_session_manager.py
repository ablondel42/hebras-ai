...
class TestSessionManager:
    ...
    async def test_create_session(self, manager):
        ...
        session = await manager.create_session(agent="read")
    ...
    async def test_create_session_with_workspace(self, manager):
        ...
        session = await manager.create_session(agent="read", workspace="/tmp/test")
    ...
    async def test_pool_full(self, manager):
        ...
        await manager.create_session(agent="read")
    ...
    async def test_list_sessions(self, manager):
        ...
        s1 = await manager.create_session(agent="read")
    ...
    async def test_pool_frees_after_delete(self, manager):
        ...
        s3 = await manager.create_session(agent="read")
